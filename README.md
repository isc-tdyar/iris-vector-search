...
_PRE-REQUISITE_: docker ([www.docker.com](https://www.docker.com) needs to be installed and running on your machine!
...
3. Install IRIS Community Edtion in a container. This will be your SQL database server.
    ```Shell
...
5. Install packages for all demos (this might take a while - it may "freeze" for some time which looks like its stuck):
    ```Shell
